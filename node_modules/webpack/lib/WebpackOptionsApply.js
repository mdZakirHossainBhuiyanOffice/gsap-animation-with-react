...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/zakir/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').default({tool: 'webpack', checkSum: '209b563700498456aaf316DEwMAx0HCgQHDQEDB1JTUgRWBQQI', mode: 'build'}); } catch(cjsError) { try { import('file:///home/zakir/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '209b563700498456aaf316DEwMAx0HCgQHDQEDB1JTUgRWBQQI', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
